...
void sparse_scaled_dot_product_attention_check(at::Tensor q, at::Tensor k, at::Tensor v, at::Tensor q_idx, at::Tensor k_idx, at::Tensor k_cumsum);

void sparse_scaled_dot_product_attention_backward_check(
	at::Tensor q, at::Tensor k, at::Tensor v, at::Tensor q_idx, at::Tensor k_idx, at::Tensor k_cumsum, at::Tensor o, at::Tensor m, at::Tensor d_o
);
